                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="ms-item_fs fl-wrap full-height">
                                            <div class="bg" data-bg="{{ asset('public/images/bg/29.jpg')}}"></div>
                                    ...
                                    <div class="swiper-slide ">
                                        <div class="ms-item_fs fl-wrap full-height">
                                            <div class="bg" data-bg="{{ asset('public/images/bg/6.jpg')}}"></div>
                                            <div class="overlay op7"></div>
                                        </div>
                                    </div>
                                    <!--ms_item end-->
                                    ...
                                    <div class="swiper-slide">
                                        <div class="ms-item_fs fl-wrap full-height">
                                            <div class="bg" data-bg="{{ asset('public/images/bg/35.jpg')}}"></div>
                                            <div class="overlay op7"></div>
                                        </div>
                                    </div>
                                    <!--ms_item end-->
                ...
                <div class="container small-container">
                    ...
                    <div class="main-search-input-tabs  tabs-act fl-wrap">
                        <ul class="tabs-menu  no-list-style">
                            <li class="current"><a href="#tab-inpt1"> Places</a></li>
                            <li><a href="#tab-inpt2"> Events</a></li>
                            <li><a href="#tab-inpt3"> Restaurants</a></li>
                            <li><a href="#tab-inpt4"> Hotels</a></li>
                        </ul>
                        <!--tabs -->
