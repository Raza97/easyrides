                    ...
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide hov_zoom">
                                <img src="{{ asset('public/images/all/40.jpg')}}" alt="">
                                <a href="{{ asset('public/images/all/40.jpg')}}" class="box-media-zoom   popup-image"><i
                                            class="fal fa-search"></i></a>
                            </div>
                            <!-- swiper-slide end-->
                            <!-- swiper-slide-->
                            <div class="swiper-slide  hov_zoom">
                                <img src="{{ asset('public/images/all/39.jpg')}}" alt="">
                                <a href="{{ asset('public/images/all/39.jpg')}}" class="box-media-zoom   popup-image"><i
                                            class="fal fa-search"></i></a>
                            </div>
                            <!-- swiper-slide end-->
                            <!-- swiper-slide-->
                            <div class="swiper-slide  hov_zoom">
                                <img src="{{ asset('public/images/all/36.jpg')}}" alt="">
                                <a href="{{ asset('public/images/all/36.jpg')}}" class="box-media-zoom   popup-image"><i
                                            class="fal fa-search"></i></a>
                            </div>
                            <!-- swiper-slide end-->
                            <!-- swiper-slide-->
                            <div class="swiper-slide  hov_zoom">
                                <img src="{{ asset('public/images/all/37.jpg')}}" alt="">
                                <a href="{{ asset('public/images/all/37.jpg')}}" class="box-media-zoom   popup-image"><i
                                            class="fal fa-search"></i></a>
                            </div>
                            <!-- swiper-slide end-->
                            <!-- swiper-slide-->
                            <div class="swiper-slide  hov_zoom">
                                <img src="{{ asset('public/images/all/41.jpg')}}" alt="">
                                <a href="{{ asset('public/images/all/41.jpg')}}" class="box-media-zoom   popup-image"><i
                                            class="fal fa-search"></i></a>
                            </div>
                            <!-- swiper-slide end-->
                        </div>
                                ...
                                <div class="list-single-header list-single-header-inside block_box fl-wrap">
                                    <div class="list-single-header-item  fl-wrap">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <h5 style="float:left;">THE CAR</h5>
                                                <h1 class="text-dark">Lexus GS 200t
                                                    <small>2017</small>
                                                </h1>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <h5 class="listing-sec-2"><i class="fas fa-oil-can"></i> 26 MPG
                                                        </h5>
                                                        <h5 class="listing-sec-2"><i class="fas fa-car"></i>4 doors</h5>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <h5 class="listing-sec-2"><i class="fas fa-gas-pump"></i> Gas
                                                            (Premium)</h5>
                                                        <h5 class="listing-sec-2"><i class="fas fa-chair"></i>5 seats
                                                        </h5>
                                                ...
                                                <div class="geodir-category-location fl-wrap"><a href="#"><i
                                                        ...
                                                        York, USA</a> <a href="#"> <i class="fal fa-phone"></i>+38099231212</a>
                                ...
                                <div class="list-single-main-item fl-wrap block_box">
                                    ...
                                    <div class="list-single-main-item_content fl-wrap">
                                        <p>Praesent eros turpis, commodo vel justo at, pulvinar mollis eros. Mauris
                                            aliquet eu quam id ornare. Morbi ac quam enim. Cras vitae nulla condimentum,
                                            semper dolor non, faucibus dolor. Vivamus adipiscing eros quis orci
                                            fringilla, sed pretium lectus viverra. Pellentesque habitant morbi tristique
                                            senectus et netus et malesuada fames ac turpis egestas. Donec nec velit non
                                            odio aliquam suscipit. Sed non neque faucibus, condimentum lectus at,
                                            accumsan enim. </p>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas in pulvinar
                                            ...
                                            purus viverra.</p>
                                        <a href="#" class="btn color2-bg float-btn">Visit Website<i
                                ...
                                <div class="list-single-main-item fl-wrap block_box">
                                    ...
                                    <div class="list-single-main-item_content fl-wrap">
                                        <div class="listing-features fl-wrap">
                                            <ul class="no-list-style">
                                                <li><a href="#"><i class="fas fa-flux-capacitor"></i> Must be 21+ to
                                                        book</a></li>
                                                <li><a href="#"><i class="fas fa-sync"></i> Automatic transmission</a>
                                                </li>
                                                <li><a href="#"><i class="fal fa-location"></i> GPS</a></li>
                                                <li><a href="#"><i class="fas fa-music"></i> Audio input</a></li>
                                                <li><a href="#"><i class="fas fa-check-square"></i>Long-term car </a>
                                                </li>
                                                <li><a href="#"><i class="fab fa-bluetooth-b"></i> Bluetooth</a></li>
                                                <li><a href="#"><i class="fab fa-usb"></i> USB input</a></li>
                                                <li><a href="#"><i class="fas fa-road"></i>Toll pass </a></li>
                                                <li><a href="#"><i class="fas fa-chair"></i>Heated seats </a></li>
                                                <li><a href="#"><i class="fas fa-sunset"></i>Sunroof </a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="reviews-comments-item">
                                                ...
                                                <div class="reviews-comments-item-text fl-wrap">
                                                    ...
                                                    <div class="review-images ">
                                                        <a href="images/all/13.jpg" class="image-popup"><img
                                                                    src="{{ asset('public/images/all/13.jpg')}}" alt=""></a>
                                                        <a href="images/all/35.jpg" class="image-popup"><img
                                                                    src="{{ asset('public/images/all/35.jpg')}}" alt=""></a>
                                                    </div>
                                                    <div class="reviews-comments-item-footer fl-wrap">
                                                        <div class="reviews-comments-item-date"><span><i
                                        ...
                                        <form id="add-comment" class="add-comment  custom-form" name="rangeCalc">
                                            <fieldset>
                                                ...
                                                <div class="list-single-main-item_content fl-wrap">
                                                    ...
                                                    <textarea cols="40" rows="3" name="ls2_textarea"
                            ...
                            <div class="box-widget-item fl-wrap block_box">
                                ...
                                <div class="box-widget opening-hours fl-wrap">
                                    <div class="box-widget-content">
                                        <ul class="no-list-style">
                                            <li class="mon"><span class="opening-hours-day">Monday </span><span
                                                        class="opening-hours-time">9 AM - 5 PM</span></li>
                                            <li class="tue"><span class="opening-hours-day">Tuesday </span><span
                                                        class="opening-hours-time">9 AM - 5 PM</span></li>
                                            <li class="wed"><span class="opening-hours-day">Wednesday </span><span
                                                        class="opening-hours-time">9 AM - 5 PM</span></li>
                                            <li class="thu"><span class="opening-hours-day">Thursday </span><span
                                                        class="opening-hours-time">9 AM - 5 PM</span></li>
                                            <li class="fri"><span class="opening-hours-day">Friday </span><span
                                                        class="opening-hours-time">9 AM - 5 PM</span></li>
                                            <li class="sat"><span class="opening-hours-day">Saturday </span><span
                                                        class="opening-hours-time">9 AM - 3 PM</span></li>
                                            <li class="sun"><span class="opening-hours-day">Sunday </span><span
                                    ...
                                    <div class="box-widget-content">
                                        <div class="form-group col-md-12" style="text-align: left;">
                                            <select id="pickup_location"
                                                    class="form-control pickup_locations ride-search">
                                                <option selected>Enter the Pickup Location</option>
                                                <option>...</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-md-12" style="text-align: left;">
                                            <select id="destination_location"
                                                    class="form-control destination_locations ride-search">
                                                <option selected>Enter the Destination</option>
                                                <option>...</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-md-12" style="text-align: left;">
                                            ...
                                            <div class="col-2">
                                                <input class="form-control ride-search" type="date" value="2011-08-19"
                                        ...
                                        <div class="form-group col-md-4">
                                            <button type="submit" formaction="listing-rides-search.html"
                                                    class="btn btn-primary">Ride Now <i class="far fa-search"></i>
                                            </button>
                                        </div>
