    ...
    <div id="wrapper">
        ...
        <div class="content">
            ...
            <section class="parallax-section single-par" data-scrollax-parent="true">
                <div class="bg par-elem " data-bg="{{ asset('public/images/bg/35.jpg')}}"
                ...
                <div class="container">
                    <div class="section-title center-align big-title">
                        ...
                        <div class="breadcrumbs fl-wrap"><a href="#">Home</a><a href="#">Listings</a><span>Listings Without Map</span>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div id="filters-search" class="tab-content  first-tab ">
                                        <div class="fl-wrap">
                                                    ...
                                                    <div class="listsearch-input-item">
                                                        <button class="header-search-button color-bg"
                                                                onclick="window.location.href='listing.html'"><i
                                                                    class="far fa-search"></i><span>Search</span>
                                                        </button>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="hidden-listing-filter fl-wrap">
                                                ...
                                                <div class="listsearch-input-item">
                                                    <div class=" fl-wrap filter-tags">
                                                        <ul class="no-list-style">
                                                            <li>
                                                                <input id="check-aa" type="checkbox"
                                                                       name="hotel_check1">
                                                                <label for="check-aa">Elevator in building</label>
                                                            </li>
                                                            <li>
                                                                <input id="check-b" type="checkbox" name="hotel_check2">
                                                                <label for="check-b">Friendly workspace</label>
                                                            </li>
                                                            <li>
                                                                <input id="check-c" type="checkbox" name="hotel_check3"
                                                                       checked>
                                                                <label for="check-c">Instant Book</label>
                                                            </li>
                                                            <li>
                                                                <input id="check-d" type="checkbox" name="hotel_check4">
                                                                <label for="check-d">Wireless Internet</label>
                                                            </li>
                                                            <li>
                                                                <input id="check-d2" type="checkbox" name="hotel_check5"
                                                                       checked>
                                                                <label for="check-d2">Free WiFi</label>
                                                            </li>
                                                            <li>
                                                                <input id="check-d3" type="checkbox" name="hotel_check6"
                                                                       checked>
                                                                <label for="check-d3">Free Parking</label>
                                                            </li>
                                                            <li>
                                                                <input id="check-d4" type="checkbox"
                                                                       name="hotel_check7">
                                            ...
                                            <div class="more-filter-option-wrap">
                                                <div class="more-filter-option-btn act-hiddenpanel color2-bg"><i
                                                    ...
                                                    <div class="swiper-wrapper">
                                                        ...
                                                        <div class="swiper-slide">
                                                            <a class="category-carousel-item fl-wrap full-height"
                                                               href="#">
                                                                <img src="{{ asset('public/images/all/34.jpg')}}"
                                                                     alt="">
                                                                ...
                                                                <div class="category-carousel-item-container">
                                                                    ...
                                                                    <div class="category-carousel-item-counter">14
                                                                        listings
                                                                    </div>
                                                                </div>
                                                            </a>
                                                        ...
                                                        <div class="swiper-slide">
                                                            <a class="category-carousel-item fl-wrap full-height"
                                                               href="#">
                                                                <img src="{{ asset('public/images/all/33.jpg')}}"
                                                                     alt="">
                                                        ...
                                                        <div class="swiper-slide">
                                                            <a class="category-carousel-item fl-wrap full-height"
                                                               href="#">
                                                                <img src="{{ asset('public/images/all/10.jpg')}}"
                                                                     alt="">
                                                                <div class="category-carousel-item-icon blue-bg"><i
                                                                            class="fal fa-dumbbell"></i></div>
                                                                <div class="category-carousel-item-container">
                                                                    <div class="category-carousel-item-title">Fitness /
                                                                        Gym
                                                                    </div>
                                                                    <div class="category-carousel-item-counter">18
                                                                        listings
                                                                    </div>
                                                                </div>
                                                            </a>
                                                        ...
                                                        <div class="swiper-slide">
                                                            <a class="category-carousel-item fl-wrap full-height"
                                                               href="#">
                                                                <img src="{{ asset('public/images/all/11.jpg')}}"
                                                                     alt="">
                                                                ...
                                                                <div class="category-carousel-item-container">
                                                                    ...
                                                                    <div class="category-carousel-item-counter">19
                                                                        listings
                                                                    </div>
                                                                </div>
                                                            </a>
