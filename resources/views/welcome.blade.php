            ...
            <section class="hero-section" data-scrollax-parent="true">
                <div class="bg-tabs-wrap">
                    <div class="bg-parallax-wrap" data-scrollax="properties: { translateY: '200px' }">
                        <div class="bg bg_tabs" data-bg="{{ asset('public/images/bg/hero/1.jpg')}}"></div>
                ...
                <div class="container small-container">
                    ...
                    <div class="main-search-input-tabs  tabs-act fl-wrap">
                        <ul class="tabs-menu change_bg no-list-style">
                            <li class="current"><i class="fa fa-car"></i><a href="#tab-inpt1"
                                                                            data-bgtab="{{ asset('public/images/bg/hero/1.jpg')}}">
                                    Ride</a>
                            </li>
                            <li><i class="fas fa-building"></i><a href="#tab-inpt2"
                                                                  data-bgtab="{{ asset('public/images/bg/hero/2.jpg')}}">
                                    Hotels</a></li>
                            <li><i class="fas fa-utensils"></i><a href="#tab-inpt3"
                                                                  data-bgtab="{{ asset('public/images/bg/hero/3.jpg')}}">
                                    Eat</a></li>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group col-md-12" style="text-align: left;">
                                                    <select id="pickup_location" name="pickup_locations"
                                                ...
                                                <div class="form-group col-md-12" style="text-align: left;">
                                                    <select id="destination_location" name="destination_locations"
                                                ...
                                                <div class="form-group col-md-4">
                                                    <button type="submit" formaction="listing-rides-search.html"
                                                            class="btn btn-primary" name="search_now">Search Now <i
                                                                class="far fa-search"></i></button>
                                                </div>
                                                <div class="form-group col-md-8">
                                                    <button type="submit" class="btn btn-primary schedul"
                                                            name="schedule_for_later">Schedule For Later <i
                                                                class="far fa-angle-right"></i></button>
                                                </div>

                                            </div>
                                            <div class="col-md-6">
                                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d924244.0619641689!2d66.59499551729773!3d25.192146526892635!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3eb33e06651d4bbf%3A0x9cf92f44555a0c23!2sKarachi%2C%20Karachi%20City%2C%20Sindh%2C%20Pakistan!5e0!3m2!1sen!2sus!4v1581785745901!5m2!1sen!2sus"
                                                        style="width: 100%;
                                    ...
                                    <form>
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-12">
                                                    <h2 style="text-align: left;">Book unique places to stay and things
                                                        to do.</h2>
                                                </div>
                                                <div class="form-group col-md-12" style="text-align: left;">
                                                    <label for="example-date-input" class="col-2 col-form-label">Your
                                                        Destination</label>
                                                    <select id="pickup_location" name="destination_locations"
                                                            class="form-control pickup_locations ride-search">
                                                ...
                                                <div class="form-group col-md-6" style="text-align: left;">
                                                    <label for="example-date-input"
                                                           class="col-2 col-form-label">CHECKIN</label>
                                                    <div class="col-2">
                                                        <input class="form-control ride-search" type="date"
                                                               value="2011-08-19" id="example-date-input"
                                                               name="hotel_checkin">
                                                ...
                                                <div class="form-group col-md-6" style="text-align: left;">
                                                    <label for="example-date-input" class="col-2 col-form-label">CHECKOUT</label>
                                                    <div class="col-2">
                                                        <input class="form-control ride-search" type="date"
                                                               value="2011-08-19" id="example-date-input"
                                                               name="hotel_checkout">
                                                ...
                                                <div class="form-group col-md-4" style="text-align: left;">
                                                    <label for="example-date-input"
                                                           class="col-2 col-form-label">Rooms</label>
                                                    <select id="pickup_location" name="hotel_rooms"
                                                            class="form-control pickup_locations ride-search">
                                                ...
                                                <div class="form-group col-md-4" style="text-align: left;">
                                                    <label for="example-date-input"
                                                           class="col-2 col-form-label">Adults</label>
                                                    <select id="pickup_location" name="hotel_adults"
                                                            class="form-control pickup_locations ride-search">
                                                        <option selected>1</option>
                                                        <option>...</option>
                                                    </select>
                                                ...
                                                <div class="form-group col-md-4" style="text-align: left;">
                                                    <label for="example-date-input" class="col-2 col-form-label">Children</label>
                                                    <select id="pickup_location" name="hotel_children"
                                                            class="form-control pickup_locations ride-search">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <button type="submit" formaction="listing-hotel-search.html"
                                                            class="btn btn-primary">Search Now <i
                                                                class="far fa-search"></i></button>
                                                </div>
                                ...
                                <div id="tab-inpt3" class="tab-content">
                                    <form>
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <h2>Your favorite food, delivered with Easy Rides</h2>
                                            </div>
                                            <div class="form-group col-md-12" style="text-align: left;">
                                                <select id="pickup_location" name="eat_address"
                                                        class="form-control pickup_locations ride-search">
                                            ...
                                            <div class="form-group col-md-12">
                                                <button type="submit" formaction="listing-eat-search.html"
                                                        class="btn btn-primary">Order Now <i class="far fa-search"></i>
                                                </button>
                                            </div>
